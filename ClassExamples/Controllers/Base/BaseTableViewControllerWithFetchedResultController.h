//
//  PTTableViewControllerWithFetchResultController.h
//
...
@interface BaseTableViewControllerWithFetchedResultController : BaseTableViewController <NSFetchedResultsControllerDelegate>
